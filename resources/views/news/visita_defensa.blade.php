            ...
            <div class="row">
                <div class="col-lg-8 col-10 mx-auto">
                    ...
                    <p class="me-4" data-aos="fade-up">El día jueves , tuvimos el agrado de recibir la visita de
                        funcionarios nacionales pertenecientes a <a href="https://www.instagram.com/mindefarg/"><strong>@mindefarg</strong></a> Ministerio de defensa de la nación.
                    ...
                    <div class="clearfix my-4 mt-lg-0 mt-5">
                        <div class="col-md-6 float-md-end mb-3 ms-md-3" data-aos="fade-up">
                            <figure class="figure">
                                <img src="{{ asset('images/news/visita1.jpg') }}" class="img-fluid news-image" alt="">                                
                            </figure>
                        </div>
    
                        <p data-apps="fade-up">Agradecemos el interés en nuestra cooperativa, también queremos hacer extensivo
                            el agradecimiento a funcionarios provinciales y municipales que se hicieron presentes demostrando su
                            compromiso con la economía social , apoyando al desarrollo productivo local .
                            Fernando Caviglia (Secretario de Industria y comercio) Jesús Pérez Mendoza (Vicerrector de comercio
                            Interior) Dr Ricardo Etchemendy (Director de ipcymer) y el licenciado Jonatan Jauregui (Director de
                            Cooperativa y Mutuales de la municipalidad de Paraná)
                            La comitiva también fue acompañada por diputado provincial Julio Solanas y la concejal Ana Ruberto
                        </p>
                    </div>
